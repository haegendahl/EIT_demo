function R = MakeAnisotropicRegMat3DHorisontalCrack(Node,Element,glim,lambda)
...
for ii=1:NElement
   ...
   if (sum(abs(gg(:,3)-glim(3,1))<1e-4)==3) | (sum(abs(gg(:,3)-glim(3,2))<1e-4)==3)
