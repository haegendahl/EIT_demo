function [A]=FemMatrix3d2ndLinSigma2(Node,Element,Hlin,sigma,z,C);
...
%disp('** Using NETGEN-type ordering of element nodes (see sfl-vector in FemMatrix3d2ndLinSigma.m)')
%sfl = [1:5 8 6 7 9 10];  % NETGEN only, the colums of H matrix must be applied in this order for the
sfl = 1:10;                         % integration
