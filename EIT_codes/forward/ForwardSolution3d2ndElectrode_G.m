function [U,Upot,Ucur, A,R,p]=ForwardSolution3d2ndElectrode_G(Node,Element,T,sigma,z,MeasPattern,style)
...
disp('Organized mesh topology expected!')
...
[A]=FemMatrix3d2ndLinSigma_fix(Node,Element,sigma,z,C);
