function [U,A,R,p]=ForwardSolution3d2nd(Node,Element,T,sigma,z,MeasPattern,style,meshtype);
...
[A]=FemMatrix3d2nd(Node,Element,sigma,z,C,meshtype);
...
U.Electrode=MeasPattern'*C*UU(sN+1:sA,size(II1,2)+1:size(UU,2));%Voltages on the electrodes
