function [ rho0,z0,Uhat,J ] = HomogeneousEstimate(H,g,Node,Element,Umeas,T,MeasPatt,Gamma_n,init_sigma,init_z,REMOVE_CURRENT_INJECTING_ELECTRODE_DATA,c_inj_data_ind);
